...
lyr_Foragegrosdbit_2.set('fieldLabels', {'N°': 'no label', 'Région': 'inline label - always visible', 'Province': 'inline label - always visible', 'Commune': 'inline label - always visible', 'Village': 'inline label - always visible', 'X': 'inline label - always visible', 'Y': 'inline label - always visible', 'Entreprise': 'inline label - always visible', 'Contact': 'inline label - always visible', 'Année-Ré': 'inline label - always visible', 'Taux d\'ex�': 'inline label - always visible', });
