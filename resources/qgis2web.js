...
map.getView().fit([-665980.472451, 928419.265628, 687729.530487, 1737479.095167], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte interactive des sites de forage à gros débit</h2>';
        return titleElement;
    })(),
